...
export default function Home() {
  const heroImages: GalleryImage[] = [
    { id: "1", image_url: "/carousel/Career in IT.jpg", caption: "Career in IT", order: 1 },
    { id: "2", image_url: "/carousel/Software Testing.jpg", caption: "Software Testing", order: 2 },
    { id: "3", image_url: "/carousel/WordpressXReact.jpg", caption: "Wordpress x React", order: 3 },
  ];
