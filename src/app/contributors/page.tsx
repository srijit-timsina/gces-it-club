      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 1.5rem 6rem" }}>
        ...
        <div className="glass-card" style={{ marginTop: "5rem", padding: "3rem", textAlign: "center", borderRadius: "24px" }}>
          ...
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            <a href="https://github.com/srijit-timsina/gces-it-club" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ display: "flex", alignItems: "center", gap: "8px" }}>
